...
> **Period covered:** 2026-02-09 through 2026-05-16
> **Total commits:** 3,229
> **Tracker:** [`.beads/issues.jsonl`](https://github.com/Dicklesworthstone/frankenfs/blob/main/.beads/issues.jsonl) (2,703 closed, 34 open as of cutoff)
...
- **Mount subcommand surface expansion** -- the `mount` subcommand now exposes `--runtime-mode {standard|managed|per-core}`, `--writeback-cache` plus three accepted-artifact flags, `--writeback-cache-kill-switch`, `--background-repair`, `--background-scrub-ledger`, `--background-scrub-interval-secs`, `--adaptive-runtime` plus its manifest/summary flags, `--managed-unmount-timeout-secs`, `--subvol`, `--snapshot`, `--external-journal`, `--ext4-journal-replay-mode`, and `--ext4-data-err-policy`
