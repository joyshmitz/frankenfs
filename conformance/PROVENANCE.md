...
### ext4_dir_block*.json (10 variants)
- **Created:** 2026-04-13
- **Author:** Claude Opus 4.5
...
- **Generated by:** `ext4_fscrypt_legacy_policy_transport_discrepancy_conforms`
- **Source images:** In-test synthetic ext4 image from `build_ext4_fscrypt_policy_image`
- **mkfs version:** N/A; hand-built fscrypt policy image, not mkfs-derived
- **Command:** `cargo test -p ffs-harness --test conformance ext4_fscrypt_legacy_policy_transport_discrepancy_conforms`
...
- **Generated by:** `representative_btrfs_item_payloads_exact_golden_contract`
- **Source images:** N/A; generated from representative btrfs item encoders in `crates/ffs-btrfs/src/lib.rs`
- **mkfs version:** N/A; encoder golden, not mkfs-derived
- **Command:** `cargo test -p ffs-btrfs representative_btrfs_item_payloads_exact_golden_contract`
