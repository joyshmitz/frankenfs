...
- [ ] OEI-002 / `bd-rchk7.2` tracks remaining deep repair corpus expansion; `bd-u8hx5` now covers deterministic fuzz-smoke expansion with fixed seeds, provenance, minimization, quarantine, and artifact requirements.
