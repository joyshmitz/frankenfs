...
RCH_CAPTURE_VISIBILITY="${FFS_REPAIR_5PCT_RCH_VISIBILITY:-${RCH_VISIBILITY:-summary}}"
SELF_CHECK="${FFS_REPAIR_5PCT_SELF_CHECK:-0}"
SKIP_SELF_CHECK="${FFS_REPAIR_5PCT_SKIP_SELF_CHECK:-0}"

e2e_rch_add_env_allowlist CARGO_TARGET_DIR FFS_REPAIR_E2E_ARTIFACT_DIR FFS_REPAIR_E2E_ARTIFACT_STDOUT
