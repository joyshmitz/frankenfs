...
# Verify the topology runtime advisor RCH capture contract without running cargo
FFS_E2E_DISABLE_TEMP_CLEANUP=1 FFS_TOPOLOGY_RUNTIME_ADVISOR_SELF_CHECK=1 ./scripts/e2e/ffs_topology_runtime_advisor_e2e.sh
...
# Verify the refresh policy RCH capture contract without running cargo
FFS_E2E_DISABLE_TEMP_CLEANUP=1 FFS_REFRESH_POLICY_SELF_CHECK=1 ./scripts/e2e/ffs_refresh_policy_e2e.sh
...
# Verify the crash matrix RCH capture contract without running cargo
FFS_E2E_DISABLE_TEMP_CLEANUP=1 FFS_CRASH_MATRIX_SELF_CHECK=1 ./scripts/e2e/ffs_crash_matrix_e2e.sh
...
# Verify the btrfs write-churn RCH capture contract without running cargo
FFS_E2E_DISABLE_TEMP_CLEANUP=1 FFS_BTRFS_WRITE_CHURN_SELF_CHECK=1 ./scripts/e2e/ffs_btrfs_write_churn_e2e.sh

# Verify the WAL replay RCH capture contract without running cargo
FFS_E2E_DISABLE_TEMP_CLEANUP=1 FFS_WAL_REPLAY_SELF_CHECK=1 ./scripts/e2e/ffs_wal_replay_e2e.sh

# Verify the WAL writer RCH capture contract without running cargo
FFS_E2E_DISABLE_TEMP_CLEANUP=1 FFS_WAL_WRITER_SELF_CHECK=1 ./scripts/e2e/ffs_wal_writer_e2e.sh
...
# Verify the benchmark expansion RCH capture contract without running cargo
FFS_E2E_DISABLE_TEMP_CLEANUP=1 FFS_BENCHMARK_EXPANSION_SELF_CHECK=1 ./scripts/e2e/ffs_benchmark_expansion_e2e.sh

# Verify the baseline validation RCH capture contract without running cargo
FFS_E2E_DISABLE_TEMP_CLEANUP=1 FFS_BASELINE_VALIDATION_SELF_CHECK=1 ./scripts/e2e/ffs_baseline_validation_e2e.sh
