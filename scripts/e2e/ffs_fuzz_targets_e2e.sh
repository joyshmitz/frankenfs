...
e2e_cleanup_tmp_file "$BUILD_LOG"
...
for target in "${EXPECTED_TARGETS[@]}"; do
    ...
    e2e_cleanup_tmp_file "$SMOKE_LOG"
done
...
")
    ...
    e2e_cleanup_tmp_file "$CAMPAIGN_LOG"
    e2e_cleanup_tmp_dir "$FUZZ_ARTIFACTS_DIR"
