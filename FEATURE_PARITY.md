...
| `harness::btrfs_fallocate_preallocates_only_uncovered_holes_conforms` | `fallocate` over mixed live-data and hole ranges | supported | success, preallocation inserts only uncovered unwritten hole extents, live data extents remain initialized, FIEMAP extents are non-overlapping, readback preserves data |
