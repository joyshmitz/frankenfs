# FrankenFS Baseline — 20260503-bd-rchk5-3-mount-cold-sudo-measured

## Metadata

- Date (UTC): `2026-05-03T21:16:13Z`
...
- `sudo -n scripts/mount_benchmark_probe.sh --bin /data/tmp/rch_target_frankenfs_bd_rchk5_3_mount_warm/release-perf/ffs-cli --image baselines/hyperfine/20260503-bd-rchk5-3-mount-warm/mount_probe.ext4 --mount-root baselines/hyperfine/20260503-bd-rchk5-3-mount-cold-sudo-measured/mount_probe_mounts --mode cold --out-json baselines/hyperfine/20260503-bd-rchk5-3-mount-cold-sudo-measured/ffs_cli_mount_cold_probe_report.json`
...
- ffs-block cache metrics skipped by --op mount_cold

## Benchmark Summary

| Command | Runner | Mean (ms) | Stddev (ms) | p50 (ms) | p95 (ms) | p99 (ms) | JSON |
|---|---|---:|---:|---:|---:|---:|---|
| ffs-cli mount cold ext4 probe (fuse) | hyperfine | 167.194 | 2.416 | 166.197 | 171.096 | 171.096 | `baselines/hyperfine/20260503-bd-rchk5-3-mount-cold-sudo-measured/ffs_cli_mount_cold_probe.json` |
