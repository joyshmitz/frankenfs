# FrankenFS Baseline — 20260503-bd-rchk5-3-mount-recovery-sudo-measured

## Metadata

- Date (UTC): `2026-05-03T21:16:16Z`
...
- Operation filter: `mount_recovery`
...
- `sudo -n scripts/mount_benchmark_probe.sh --bin /data/tmp/rch_target_frankenfs_bd_rchk5_3_mount_warm/release-perf/ffs-cli --image baselines/hyperfine/20260503-bd-rchk5-3-mount-warm/mount_recovery_probe.ext4 --mount-root baselines/hyperfine/20260503-bd-rchk5-3-mount-recovery-sudo-measured/mount_probe_mounts --mode recovery --out-json baselines/hyperfine/20260503-bd-rchk5-3-mount-recovery-sudo-measured/ffs_cli_mount_recovery_probe_report.json`
...
- ffs-block cache metrics skipped by --op mount_recovery

## Benchmark Summary

| Command | Runner | Mean (ms) | Stddev (ms) | p50 (ms) | p95 (ms) | p99 (ms) | JSON |
|---|---|---:|---:|---:|---:|---:|---|
| ffs-cli mount recovery ext4 probe (journal replay) | hyperfine | 70.705 | 3.326 | 68.972 | 74.217 | 74.217 | `baselines/hyperfine/20260503-bd-rchk5-3-mount-recovery-sudo-measured/ffs_cli_mount_recovery_probe.json` |
